...
import com.mycompany.calculator.util.Converter;
...
String postFix = converter.infixToPostFix(jTextField1.getText().trim());
double ans = converter.evaluatePostfix(postFix);
jTextField1.setText("");
String finalAns =  String.valueOf(ans);
jTextField1.setText(finalAns.endsWith(".0") ? finalAns.substring(0, finalAns.length()-2) : finalAns);
        } catch(Exception e) {
            jOptionPane1.showMessageDialog(jDialog1, e.getMessage(), "Error", jOptionPane1.ERROR_MESSAGE);
            jTextField1.setText("");
        }
    ...
    private void jButton20ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton20ActionPerformed
        ...
        int newLength = jTextField1.getText().length() - 1;
        String store = "";
